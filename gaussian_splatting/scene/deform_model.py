...
class DeformModel:
    ...
    def load_weights(self, model_path, iteration=81500):
        #if iteration == -1:
        #    loaded_iter = searchForMaxIteration(os.path.join(model_path, "deform"))
        #else:
        #    loaded_iter = iteration
        weights_path = os.path.join(model_path, f"deform/iteration_{iteration}/deform.pth")
        print('Loading deform weights from:', weights_path)
